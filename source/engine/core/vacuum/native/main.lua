...
function native_callback_init(width, height, game_lua)
    ...
    std.image.mensure_width=function(v) return select(1, native_image_mensure) end
    std.image.mensure_height=function(v) return select(2, native_image_mensure) end
    ...
    std.text.mensure_width=function(v) return select(1, native_image_mensure) end
    std.text.mensure_height=function(v) return select(2, native_image_mensure) end
