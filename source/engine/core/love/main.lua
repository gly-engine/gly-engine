...
local lib_api_encoder = require('source/engine/api/system/encoder')
local lib_api_game = require('source/engine/api/system/app')
local lib_api_hash = require('source/engine/api/system/hash')
local lib_api_http = require('source/engine/api/system/http')
local lib_api_i18n = require('source/engine/api/system/i18n')
local lib_api_key = require('source/engine/api/system/key')
local engine_log = require('source/engine/api/system/log')
local lib_api_math = require('source/engine/api/system/math')
local lib_api_media = require('source/engine/api/system/media')
local lib_api_array = require('source/engine/api/system/array')
...
function love.load(args)
    ...
    zeebo_module.require(std, application, engine)
        ...
        :package('math.wave', lib_api_math.wave)
