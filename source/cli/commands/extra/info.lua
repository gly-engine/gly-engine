...
local help_message = "Available commands:\n"
  ...
  .."-" .. "-profile: Enables the Lua profile for application code during run.\n"
  ...
  .."- To run a game: ./cli.sh run ./samples/asteroids/game.lua\n"
  .."- To profile a game: ./cli.sh run ./samples/asteroids/game.lua "  .. "-" .. "-profile\n"
